...
| 04 | Docs sweep ([phase-04-docs-sweep.md](phase-04-docs-sweep.md)): README release-notes/dashboard/CLI-reference prose, `plugin/skills/auto/SKILL.md` + `escalate/SKILL.md` wording, ASCII mock; screenshot regeneration stays a human action | review      |
